...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.prova2.vitorgallera.drinksguys.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.prova2.vitorgallera.drinksguys.utils.GlideOptions().apply(toSet));
    }
  }
}
